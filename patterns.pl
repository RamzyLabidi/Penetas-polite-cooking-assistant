...
pattern([a30recipe, [agent, recipeConfirm], [agent, repeat(a30recipeStep)], [agent, finalStep],  [agent, terminate]]).
...
% the first feature country of origin
% the second feature is the kind of diet it is
% the third feature is the height of calories the user wants in its recipe (high, medium, low)
pattern([a5recipeName, [agent, recipeCountryDietCalorie], 
	[user,  recipeRequestCountry], [agent, recipeCountryChoice]]).
...
pattern([a5recipeName, [agent, recipeCountryDietCalorie], 
 	[user,  recipeRequestCalorie], [agent, recipeCalorieChoice]]).
 	
%For when the user has no preference	
pattern([a5recipeName, [agent, recipeCountryDietCalorie], 
...
% Positive result
pattern([a50ingredientsCheck, [agent, introIngredientsCheck], [agent, ingredientsCheck1], [agent, ingredientsCheck2],
	[user, confirmation], [agent, positiveReceipt]]).

%Negative result
%pattern([a50ingredientsCheck,  [agent,introIngredientsCheck],[agent, ingredientsCheck], 
%	[user, disconfirmation], [agent, negativeWelfareReceipt], [agent, terminate]]).
pattern([a50ingredientsCheck, [agent, introIngredientsCheck], [agent, ingredientsCheck1], [agent, ingredientsCheck2],
	[user, disconfirmation], [agent, negativeWelfareReceipt], [agent, terminate]]).
% Positive result
pattern([a50utensilsCheck, [agent, introUtensilsCheck], [agent, utensilsCheck], 
	[user, confirmation], [agent, positiveReceipt]]).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%pattern([b100featureRequest, [user, featureRequest], [agent, new(a5recipeName)], [agent, new(a50recipeName)]]).

%pattern([b100featureRequest, [user, featureRequest], [agent, limitedExpertise], 
%	[agent, describeCapability]]).%, [agent, new(a50recipeName)]]).
...
pattern([c3checkCapability, [user, checkCapability], [agent, describeCapability]]).
